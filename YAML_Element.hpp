...
//    //! Add a child element to an element list associated with this element, value of type posit
//    YAML_Element* add(const std::string& key_arg, positX& value_arg);
...
//  std::string convert_posit_to_string(positX value_arg);
};
