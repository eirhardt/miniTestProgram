...
//YAML_Element *YAML_Element::add(const std::string &key_arg, positX& value_arg) {
//  this->value = "";
//  string converted_value = convert_posit_to_string(value_arg);
//
//  YAML_Element* element = new YAML_Element(key_arg, converted_value);
//  children.push_back(element);
//  return element;
...
//TODO - figure this out
//string YAML_Element::convert_posit_to_string(positX value_arg){
//  stringstream strm;
//  strm << value_arg;
//  return strm.str();
//}
